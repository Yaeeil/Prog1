...
secuencias(arrDatos, arrPatron);
}
public static void secuencias(int []arrDatos, int []arrPatron) {
...
fin = ini;//para que arranque desde la posicion que debe ya que hubo corrimiento
}
}
else
